Shader "Custom/xgFont_test10" {
	...
	SubShader {
		...
		v2f vert(appdata_full  v)
		{
			...
			//
			//fixed ir = v.color.r;
			//fixed ig = v.color.g * 256;
			
			o.color = v.color;
			//float4 palcolor = text2D(_PalTex, float2(ir,ig)); 
		...
		{		  
			...
			float4 palcolor = float4(0,0,0,0);
			{
		    	...
		    	//uv.x = i.color.r + 0.001953125;  // 1/512 
		    	//uv.y = i.color.g + 0.001953125;  // 1/512 
				palcolor = tex2D(_PalTex, uv);
			}
			palcolor.a = palcolor.a * _Alpha;
